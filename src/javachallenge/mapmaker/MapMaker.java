        ...
        saveItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try{
                    ...
                    String answer = JOptionPane.showInputDialog("Sources[0]:","yes for " + sources[0].getX() + "," + sources[0].getY() + " no for " + sources[1].getX() + "," + sources[1].getY());
                    if(answer.toLowerCase().equals("no")){
                        Point t = sources[1];
                        sources[1] = sources[0];
                        sources[0] = t;
                    }
                    answer = JOptionPane.showInputDialog("Des[0]:","yes for " + Destination[0].getX() + "," + Destination[0].getY() + " no for " + Destination[1].getX() + "," + Destination[1].getY());
                    if(answer.toLowerCase().equals("no")){
